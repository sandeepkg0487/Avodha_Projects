                    ...
                    <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-lg">
                        ...
                        <form >
                            ...
                            <div className="mt-8">
                                ...
                                <div className="flex flex-col">
                                    <select onChange={handlInput} value={sel.value} name='roomid' id="status" className="my-2 block w-full rounded-md border border-gray-200 px-2 py-2 shadow-sm outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
